...
@interface YPUIComponentTableViewCell ()

@property (nonatomic, strong) UILabel *titleLabel;

@end

@implementation YPUIComponentTableViewCell
...
- (void)setCellModel:(YPUIComponentModel *)cellModel {
